...
Future<void> _loadUserData() async {
                    ...
                    child: Container(
                      decoration: const BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(9), // Slightly smaller to account for border
                            ...
                            children: [
                              Expanded(
                                child: _buildDetailColumn(
                                  Icons.attach_money,
                                  visit['worker_names'],
                                  useWorkerIcon: true, // Add this parameter
                                ),
                              ),
                            ],
                          ),
  ...
  Widget _buildDetailColumn(IconData icon, String text, {Color? statusColor, bool useWorkerIcon = false}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
  ...
  child: Row(
    children: ['today', 'upcoming'].map((tab) {
      String label = tab == 'today' ? 'Today Visits' : 'Coming Visits';
